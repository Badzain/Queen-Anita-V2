...
module.exports = {
  ...
  caption: process.env.CAPTION || "KUMAMAYE™`",
  author: process.env.PACK_AUTHER || "WEE NINFALA",
  packname: process.env.PACK_NAME || "APJEHU",
  botname: process.env.BOT_NAME || “JEHU254BOT",
  ownername: process.env.OWNER_NAME || "PUNDA MZEE",
