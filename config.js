...
global.email = "jehubender@gmail.com";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "`Punda mzee-V2™`",
  author: process.env.PACK_AUTHER || "Jehu-bot&v2",
  packname: process.env.PACK_NAME || "J E H U",
  botname: process.env.BOT_NAME || "Jehu-BoT",
  ownername: process.env.OWNER_NAME || "Jehu madclan",
